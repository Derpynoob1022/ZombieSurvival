...
//    }
//
//    public void handleCollisions(ArrayList<Entity> entities, Shape attackArea) {
//        updateQuadtree(entities);
//
//        // Iterate through all entities
//        for (Entity entity : entities) {
//            List<Collidable> possibleCollisions = new ArrayList<>();
//            quadtree.retrieve(possibleCollisions, entity);
//
//            for (Collidable collidable : possibleCollisions) {
//                if (collidable instanceof Entity) {
//                    Entity other = (Entity) collidable;
//
//                    // Check for collision with other entities
//                    if (entity != other && entity.bounds.intersects(other.bounds)) {
//                        // Handle collision response (e.g., velocity change)
//                        handleEntityCollision(entity, other);
//                    }
//
//                    // Check for attack collision
//                    if (attackArea != null && attackArea.intersects(other.hitBox)) {
//                        if (other instanceof Enemy) {
//                            Player.getInstance().handleAttack((Enemy) other);
//                        }
//                    }
//                }
//            }
...
//
//
//    private void updateQuadtree(ArrayList<Entity> entities) {
//        quadtree.clear();
...
//            double distance = playerBounds.getCenterX() - item.getBounds().getCenterX();
//            double distanceY = playerBounds.getCenterY() - item.getBounds().getCenterY();
//            double totalDistance = Math.sqrt(distance * distance + distanceY * distanceY);
//
//            if (totalDistance <= 4 * TILESIZE) {
